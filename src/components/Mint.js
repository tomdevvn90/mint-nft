        ...
        <div className="mt-8 border-[#505050] border text-white flex" onClick={() => connectwallet(setLoad,setWhiteLoad,setDisconnect,setCountdown)}>
          <div className="w-[100%] text-center group cursor-pointer">
            <div className="border-[#505050] border-b md:py-14 py-6">
              ...
              <button className="uppercase relative transition duration-500 group-hover:text-black  tracking-wider  py-6 font-simplon-bp font-bold md:text-[20px] border-[#505050]">Connect Wallet</button>
              </div>
            </div>
            <div className="relative transition duration-500 group-hover:text-black group-hover:bg-white tracking-wider  font-simplon-bp font-bold md:text-[20px]"></div>
          </div>
        </div>:
        whiteLoad?
        <div>
